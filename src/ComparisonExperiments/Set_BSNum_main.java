...
public class Set_BSNum_main {
	...
	public static void main(String[] args) throws CloneNotSupportedException, IOException {
		...
		for (int nBS = 400; nBS <= 1000; nBS += 100) {

			BufferedWriter bw = new BufferedWriter(new OutputStreamWriter(
					new FileOutputStream("ComparisonResult_BSNum-" + nBS + ".csv", true)));

			ConstNum.nBaseStation = nBS; // 600(400-1000)
