...
public class ESP_GS implements Algorithm {
	...
	public ESP_GS(int swarmSize, int maxIterations, BaseStation[] BSList, KDTree<Integer> kdTree) {
...
//			System.out.println("µÚ" + (iteration + 1) + "´Îµü´ú");
		...
		result.setBetaSquared(this.betaSquared);
